  ...
  apiWindow: {
    appWindow: {
      setFullscreen: (isFullscreen: boolean) => {
        ...
        if ((window as any).__TAURI__?.webviewWindow?.getCurrentWebviewWindow) {
          return (window as any).__TAURI__.webviewWindow.getCurrentWebviewWindow().setFullscreen(isFullscreen)
        } else {
